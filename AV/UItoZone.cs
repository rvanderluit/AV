...
namespace AV
{
    public class UItoZone
    {
        ...
        private static ushort[] _zoneCurrentStartupVols = new ushort[100];
        private static ushort[] _zoneCurrentSourceNumber = new ushort[100];
        private static string[] _zoneCurrentSourceText = new string[100];
        ...
        public static ushort[] zoneCurrentSourceNumber
        {
            get { return _zoneCurrentSourceNumber; }
            set
            {
                _zoneCurrentSourceNumber = value;
            }
        }
        public static ushort[] zoneCurrentStartupVols {
            get { return _zoneCurrentStartupVols; }
            set { _zoneCurrentStartupVols = value; }
        }
        ...
        public static string[] zoneCurrentSourceText {
            get { return _zoneCurrentSourceText; }
            set {
                _zoneCurrentSourceText = value;
            }
        }
